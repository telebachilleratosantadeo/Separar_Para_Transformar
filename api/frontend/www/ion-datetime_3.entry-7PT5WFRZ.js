...
`, this.el);
  ...
  render() {
    ...
    return h(Host, { key: "0039549c1a4098672eb827c3d6b2c8fcf8f41c53", "aria-disabled": disabled ? "true" : null, onFocus: this.onFocus, onBlur: this.onBlur, class: Object.assign({}, createColorClasses(color, {
      [mode]: true,
    ...
    })) }, h("div", { key: "72f0860a8c46aa493af28819d2e49689358b8357", class: "intersection-tracker", ref: (el2) => this.intersectionTrackerRef = el2 }), this.renderDatetime(mode));
  }
  get el() {
...
var PickerColumnCmp = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./index-CfgBF1SE-A6CX6CP6.js")).createGesture({
        el: this.el,
...
@ionic/core/dist/esm/ion-datetime_3.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-datetime_3.entry-7PT5WFRZ.js.map
