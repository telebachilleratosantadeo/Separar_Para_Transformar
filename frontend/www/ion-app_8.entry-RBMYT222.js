...
} from "./chunk-PLB5D5WG.js";
import {
  getTimeGivenProgression
} from "./chunk-W7NNY2EY.js";
import {
  transition
} from "./chunk-IMOXAELS.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-GASV5LRO.js";
...
} from "./chunk-RQD4YPJN.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-3IM67RMO.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-OM75IFBM.js";
import "./chunk-CUYIUJP7.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-W6ER52DC.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-PLJOXF7D.js";
import {
  shouldUseCloseWatcher
} from "./chunk-CIJRZ76T.js";
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-UKEIMS6X.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-VURIMMUU.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-AaDhOpKN-RQTJFKQ4.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CTe4XmL7-2XMW6QPK.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-3TTBYQHH.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-56KZZ2SX.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BZBFwTQV-MTSGFRY5.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-RBMYT222.js.map
